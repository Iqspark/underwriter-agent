...
| **2** | **RAG grounding** (wordings/guidelines/precedent, cited rationale; offline ONNX embeddings into **pgvector**) | Biggest *credibility* win; reuses the Phase 1 Postgres |
...
| **6** | **Evaluator + autonomy tiers** — the **`ReviewerAgent`** critic ([ADR-0022](adr/0022-reviewer-agent.md)), layered guardrails, STP routing | Unlocks safe straight-through — now measurable & audited |
