...
| NFR-10 | Observability | [doc 10](10-runtime-audit-observability.md) | 0010, 0027 | Built (metrics + business KPIs + dashboard + outcome flywheel); Grafana/warehouse + drift Designed |
...
| Q3 | **Build vs buy** enrichment data (peril/property/geo) | Pluggable via MCP either way. Boundary **built** ([ADR-0026](adr/0026-mcp-enrichment.md)); offline provider default, MCP servers plug in behind it | Phase 4 |
